    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieTicketInShoppingCarts", x => new { x.MovieTicketId, x.ShoppingCartId });
                    table.ForeignKey(
                        name: "FK_MovieTicketInShoppingCarts_ShoppingCarts_MovieTicketId",
                        column: x => x.MovieTicketId,
                        principalTable: "ShoppingCarts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieTicketInShoppingCarts_MovieTickets_ShoppingCartId",
